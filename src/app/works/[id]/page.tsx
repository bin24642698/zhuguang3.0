    ...
    <div className="flex-1 flex flex-col h-full bg-card-color rounded-xl overflow-hidden border border-[rgba(120,180,140,0.4)] shadow-md relative">
      <div className="p-4 border-b border-[rgba(120,180,140,0.3)] flex justify-between items-center">
        ...
        <input
          ...
          className="w-1/4 text-3xl font-bold border-none focus:outline-none focus:ring-0 bg-transparent text-text-dark hidden sm:block"
          placeholder="章节标题"
          style={{ fontFamily: "'Ma Shan Zheng', cursive" }}
        />

        {/* 按钮组 - 在小屏幕上占据全部宽度 */}
        <div className="flex items-center space-x-2 overflow-x-auto scrollbar-thin pr-2 sm:ml-2 flex-grow sm:flex-grow-0" style={{ scrollbarWidth: 'thin' }}>
          <button
            onClick={() => {
          ...
          >
            ...
            <span className="ml-1 md:ml-1.5 text-xs md:text-sm font-medium whitespace-nowrap">档案馆</span>
          </button>
        ...
        {/* 右侧空间 - 在小屏幕上隐藏 */}
        <div className="w-1/3 flex justify-end hidden sm:flex">
          {/* 删除保存按钮 */}
        </div>
      </div>
